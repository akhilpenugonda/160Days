#Logic is with the Dynamic array formation and the concatenations

def longestCommonSubsequenceMine(str1, str2):
    lcs = [[[] for x in range(len(str1) + 1)] for j in range(len(str2) + 1)]
